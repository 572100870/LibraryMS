 ...
 * @generated
 */
public class LibraryActionBarContributor extends EditingDomainActionBarContributor
	...
	protected IAction showPropertiesViewAction = new Action(
			LibraryEditorPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	...
	protected IAction refreshViewerAction = new Action(
			LibraryEditorPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(LibraryEditorPlugin.INSTANCE.getString("_UI_LibraryEditor_menu"),
				"org.eclipse.sirisus.sample.libraryMenuID");
		...
		createSiblingMenuManager = new MenuManager(
				LibraryEditorPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
