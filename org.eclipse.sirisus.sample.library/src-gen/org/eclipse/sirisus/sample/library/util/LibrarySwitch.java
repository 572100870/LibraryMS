...
public class LibrarySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case LibraryPackage.LIBRARY_MANAGEMENT_SYSTEM: {
			LibraryManagementSystem libraryManagementSystem = (LibraryManagementSystem) theEObject;
			T result = caseLibraryManagementSystem(libraryManagementSystem);
			if (result == null)
		...
		case LibraryPackage.THIRD_PART_SYSTEM: {
			ThirdPartSystem thirdPartSystem = (ThirdPartSystem) theEObject;
			T result = caseThirdPartSystem(thirdPartSystem);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case LibraryPackage.LIBRARIAN_NEW: {
			LibrarianNew librarianNew = (LibrarianNew) theEObject;
			T result = caseLibrarianNew(librarianNew);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	 ...
	 * @generated
	 */
	public T caseLibraryManagementSystem(LibraryManagementSystem object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Third Part System</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Third Part System</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseThirdPartSystem(ThirdPartSystem object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Librarian New</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Librarian New</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLibrarianNew(LibrarianNew object) {
		return null;
	}
